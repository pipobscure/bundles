...
//   ./echo-argv.nzip a b                           the shell launcher prefix
//   bundle run echo-argv.nzip a b                  through the verifying mount
//   node --experimental-vfs --vfs-load=echo-argv.nzip -- a b
//
