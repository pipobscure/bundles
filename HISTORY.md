...
| `test/*.test.ts` | 162 tests: the format, the archive, the two providers, the API, the CLI, the SEA, the skills, and the published package's own shape. |
...
npm test                    # 162 tests: sign, verify, mount, run, SEA, the gate, and every refusal
```
...
bundles/
  ...
  test/           162 tests over the format, both providers, the API, the CLI, the SEA and the package
  skills/audit-bundle/
